  ...
  * BefundInvasiv 0..1 BackboneElement "Befund invasives Karzinom" "Pathologische Befundung invasives Mammakarzinom"
    ...
    * Biomarker 0..1 BackboneElement "Biomarker invasiv" "Tumor-Biomarker BC"
      ...
      * PR 0..1 BackboneElement "PR-Status (Progesteronrezeptor)" "Analog ER; IRS und Allred sind alternative Scoring-Systeme"
      ...
      // HER2-Status: IHC-Anteil hier, ISH-Reflextestung als separater Befund (MII MTB)
      * HER2 0..1 BackboneElement "HER2-Status (IHC)" "IHC-Befund; ermöglicht HER2-low-Klassifikation. ISH-Reflextestung wird über MII MTB INSITUHYBRIDIZATION_HER2 abgebildet."
        * IHCScore 0..1 CodeableConcept "HER2 IHC-Score" "0 | 1+ | 2+ | 3+"
        * ISHDurchgefuehrt 0..1 boolean "ISH durchgeführt" "wurde ISH-Reflextestung durchgeführt (typ. bei IHC 2+)? Quantitative Details siehe Genetik.ISHReflexHER2"
        * ISHStatus 0..1 CodeableConcept "ISH-Ergebnis (Zusammenfassung)" "amplifiziert | nicht amplifiziert | equivocal — Detailwerte (Ratio, Kopienzahl) in MII MTB ISH HER2"
  ...
  * BefundDCIS 0..1 BackboneElement "Befund DCIS" "Pathologische Befundung Ductales Carcinoma in situ"
    ...
    * Biomarker 0..1 BackboneElement "Biomarker DCIS" "Tumor-Biomarker DCIS"
      ...
      * PR 0..1 BackboneElement "PR-Status DCIS" "Progesteronrezeptor am DCIS"
        ...
        * IRSScore 0..1 Quantity "IRS (Remmele-Stegner)" "Immunreaktiver Score 0–12"
        * AllredScore 0..1 Quantity "Allred Score" "Allred Score 0–8"
      * HER2 0..1 BackboneElement "HER2-Status DCIS (IHC)" "IHC am DCIS; ISH-Details via MII MTB"
        * IHCScore 0..1 CodeableConcept "HER2 IHC-Score" "0 | 1+ | 2+ | 3+"
        * ISHDurchgefuehrt 0..1 boolean "ISH durchgeführt"
        * ISHStatus 0..1 CodeableConcept "ISH-Ergebnis (Zusammenfassung)" "amplifiziert | nicht amplifiziert | equivocal"
        * Gesamtstatus 0..1 CodeableConcept "HER2-Gesamtstatus" "positiv | HER2-low | HER2-ultralow | negativ | equivocal (MII-Onko Leitlinien-VS)"
...
* Pathologie.BefundInvasiv.Biomarker.HER2 -> "Senologie_HER2_Status (erbt MII Onko Her2neu Status, IHC); ISH-Reflextestung via MII_PR_MTB_INSITUHYBRIDIZATION_HER2"
...
* Pathologie.BefundInvasiv.Biomarker.HER2 -> "MII-Onko Mamma Her2neu Status (IHC: value oBDS + Leitlinie [HER2-low, HER2-ultralow]; component IHC-Score + ISH-Ergebnis); quantitative ISH-Details: MII-MTB INSITUHYBRIDIZATION_HER2 (LOINC Panel 74885-5)"
...
// HER2-ISH-Reflex (separat, weil im MTB-Modul)
* Pathologie.BefundInvasiv.Biomarker.HER2.ISHDurchgefuehrt -> "MII-MTB INSITUHYBRIDIZATION_HER2 (LOINC Panel 74885-5: Ratio, Signale/Zellkern, gezaehlte Zellen)"

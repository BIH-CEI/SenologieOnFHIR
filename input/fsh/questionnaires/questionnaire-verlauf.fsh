...
//   - Senologie_FollowUp / Observation (Tumorstatus)
// Extraktion: SDC Template-based Extraction mit contained
//   Ressourcen-Templates pro Zieltyp.
// ============================================================

// --- Contained template: Observation (Klinischer Status) ---
Instance: verlauf-klinisch-template
...
// Contained templates
* contained[+] = verlauf-klinisch-template
* contained[+] = verlauf-tumorstatus-template
...
// ============================================================
// Group 2: Klinischer Status → Observation (Template-based)
// ============================================================
...
* item[=].extension[=].extension[=].valueReference = Reference(verlauf-klinisch-template)
...
// ============================================================
// Group 3: Tumorstatus → FollowUp Observation (Template-based)
// ============================================================
...
// SDC templateExtract → contained FollowUp Observation template
* item[=].extension[+].url = "http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-templateExtract"
* item[=].extension[=].extension[+].url = "template"

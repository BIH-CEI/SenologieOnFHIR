...
* medication[x] ^comment = "Substanz: — SNOMED CT Binding auf Senologie-Medikationsliste, ATC/UNII geerbt von MII Onko"
...
* extension[therapyCycle] ^comment = "Zyklus: (1, 2, 3, etc.)"

* extension contains EX_Senologie_DayInCycle named dayInCycle 0..1
* extension[dayInCycle] ^short = "Tag im Zyklus"
* extension[dayInCycle] ^comment = "Tag: (Tag 1-N innerhalb eines Zyklus)"

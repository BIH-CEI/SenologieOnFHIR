...
Strukturierte Meldungen an klinische Krebsregister. Siehe [Meldedatensätze](anwendungsfaelle-meldedatensaetze.md).
...
Für den Datenaustausch ist eine konsistente Terminologie entscheidend. Das Modul stellt [ConceptMaps](terminologie-medikation.md) bereit, die Übersetzungen zwischen den verwendeten Kodiersystemen ermöglichen:

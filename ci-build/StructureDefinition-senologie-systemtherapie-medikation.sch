...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationStatement">
      <sch:assert test="count(f:extension[@url = 'https://www.senologie.org/fhir/StructureDefinition/ex-senologie-therapy-cycle']) &lt;= 1">extension with URL = 'https://www.senologie.org/fhir/StructureDefinition/ex-senologie-therapy-cycle': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://www.senologie.org/fhir/StructureDefinition/ex-senologie-day-in-cycle']) &lt;= 1">extension with URL = 'https://www.senologie.org/fhir/StructureDefinition/ex-senologie-day-in-cycle': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>

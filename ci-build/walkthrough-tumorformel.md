...
* [**Diagnose & Staging**](diagnose-staging.md)
* **Walkthrough — TNM und IHC**
...
Die [StructureMaps](meldung-obds.md) transformieren die FHIR-Observations in oBDS v3.0.5:
...
Die Transformation nutzt die [Reverse ConceptMaps](terminologie-uebersicht.md) für die Code-Übersetzung.

-------

## 5. Ausspielung IQTIG QS-Datensatz 18.1

Die [IQTIG-StructureMap](meldung-iqtig.md) transformiert in den QS-Datensatz:
...
Die [OncoBox-StructureMap](meldung-oncobox.md) transformiert in das OncoBox-XML:

# Fall 12: Exzisionspräparat Nachresektion links OIQ - Kerndatensatz Senologie v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Fall 12: Exzisionspräparat Nachresektion links OIQ**

## Example Specimen: Fall 12: Exzisionspräparat Nachresektion links OIQ

Profile: [BIH Senologie Pathologisches Präparat](StructureDefinition-senologie-pathologie-praeparat.md)

**identifier**: Placer Identifier/SPEC-2025-001202-A

**status**: Available

**type**: Exzisionspräparat
...
| * | 2025-08-05 | Biopsy - action | Linke Brust, oberer innerer Quadrant |
...
```json
{
  ...
  "id" : "Fall12-Pathologie-Praeparat-Nachresektion",
  "meta" : {
  ...
  "type" : {
    "coding" : [{
      ...
      "code" : "397078009",
      "display" : "Specimen obtained by excisional biopsy"
    }],

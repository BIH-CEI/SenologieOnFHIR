# Fall 1: Komorbidität — Arterielle Hypertonie - Kerndatensatz Senologie v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Fall 1: Komorbidität — Arterielle Hypertonie**

## Example Condition: Fall 1: Komorbidität — Arterielle Hypertonie
...
```json
{
  ...
  "id" : "Fall1-Komorbiditaet-Hypertonie",
  "clinicalStatus" : {
    "coding" : [{
  ...
  "code" : {
    "coding" : [{
      ...
      "version" : "2025",
      "code" : "I10",
      "display" : "Essentielle (primäre) Hypertonie"
    },
    {
      "system" : "http://snomed.info/sct",
      "code" : "38341003",

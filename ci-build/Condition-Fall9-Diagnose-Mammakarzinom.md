...
* **Fall 9: Lobuläres Mammakarzinom links, cT2 pN3a cM0**

## Example Condition: Fall 9: Lobuläres Mammakarzinom links, cT2 pN3a cM0

Profile: [BIH PR Seno Diagnose Maligne](StructureDefinition-senologie-diagnose-maligne.md)

**Condition Asserted Date**: 2025-04-02

**clinicalStatus**: Active

**verificationStatus**: histologische Untersuchung eines Primärtumors

**code**: Invasives lobuläres Mammakarzinom links, oberer äußerer Quadrant
...
> **stage****summary**: UICC IIIC (cT2 pN3a(12/18) cM0)**type**: Tumor staging
...
```json
{
  ...
  "id" : "Fall9-Diagnose-Mammakarzinom",
  "meta" : {
  ...
  "code" : {
    ...
    "text" : "Invasives lobuläres Mammakarzinom links, oberer äußerer Quadrant"
  },
  "bodySite" : [{
    "coding" : [{
      "system" : "http://snomed.info/sct",
  ...
  "stage" : [{
    "summary" : {
      "text" : "UICC IIIC (cT2 pN3a(12/18) cM0)"
    },
    "type" : {
      "coding" : [{
        "system" : "http://snomed.info/sct",

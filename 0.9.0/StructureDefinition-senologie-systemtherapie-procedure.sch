...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Procedure">
      ...
      <sch:assert test="count(f:extension[@url = 'https://www.senologie.org/fhir/StructureDefinition/ex-senologie-therapy-line']) &lt;= 1">extension with URL = 'https://www.senologie.org/fhir/StructureDefinition/ex-senologie-therapy-line': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://www.senologie.org/fhir/StructureDefinition/ex-senologie-first-line-therapy']) &lt;= 1">extension with URL = 'https://www.senologie.org/fhir/StructureDefinition/ex-senologie-first-line-therapy': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>

# Fall 7: Carboplatin, Zyklus 1, Tag 1 - Kerndatensatz Senologie v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Fall 7: Carboplatin, Zyklus 1, Tag 1**

## Example MedicationStatement: Fall 7: Carboplatin, Zyklus 1, Tag 1
...
```json
{
  ...
  "id" : "Fall7-Medikation-Carboplatin",
  "meta" : {

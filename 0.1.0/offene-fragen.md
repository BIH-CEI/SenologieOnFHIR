# Offene Fragen - Kerndatensatz Senologie v0.1.0

* [**Table of Contents**](toc.md)
* [**Technisches**](testumgebungen.md)
* **Offene Fragen**
...
1. **Symptom-basiert**— Selbsttastbefund, direkte Vorstellung
1. **Zufallsbefund**— Auffälligkeit in anderer Bildgebung
1. **Rezidiv**— bekannte Patientin, neue Behandlungsepisode
1. **Prophylaktisch**— BRCA-Mutation, Risikokonsultation
1. **Neue/Zugezogene/Internationale Patientinnen**— Vordiagnosen und Befunde aus anderem Gesundheitssystem, ggf. fremdsprachige Dokumentation, ungeklärter Versicherungsstatus

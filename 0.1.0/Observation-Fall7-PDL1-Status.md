# Fall 7: PD-L1 Status — CPS 2, negativ (22C3) - Kerndatensatz Senologie v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Fall 7: PD-L1 Status — CPS 2, negativ (22C3)**

## Example Observation: Fall 7: PD-L1 Status — CPS 2, negativ (22C3)
...
> **component****code**: PD-L1 Combined Positive Score**value**: 2 score (Details: UCUM code{score} = '{score}')**interpretation**: Negative

> **component****code**: PD-L1 Tumor Proportion Score**value**: 1 % (Details: UCUM code% = '%')

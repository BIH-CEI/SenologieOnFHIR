...
1. BET-Rate (brusterhaltende Therapie vs. Mastektomie)
1. R0/R1/R2-Verteilung
1. Altersverteilung (Boxplot)
1. Therapie-Mix pro Subtyp
1. Time-to-Treatment (Diagnose → OP)
1. Crosstab Subtyp × OP-Art
...
Die [StructureMaps](anwendungsfaelle-meldedatensaetze.md) transformieren die FHIR-Daten in die vier Meldeformate. Für die Ausführung wird ein [Matchbox](https://github.com/ahdis/matchbox)-Container empfohlen, der die FML-Maps als `$transform`-Operation bereitstellt.

# Fall 1: PALB2 somatisch — Wildtyp - Kerndatensatz Senologie v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Fall 1: PALB2 somatisch — Wildtyp**

## Example Observation: Fall 1: PALB2 somatisch — Wildtyp
...
```json
{
  ...
  "id" : "Fall1-Somatische-Mutation-PALB2",
  "meta" : {
